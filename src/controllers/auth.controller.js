...
exports.register = async (req, res) => {
    const { documento, nombre, celular, email, password, direccion, rol_id } = req.body;
  
    if (!documento || !nombre || !celular || !direccion || !rol_id) {
    ...
    try {
      const response = await authService.register({ documento, nombre, celular, email, password, direccion, rol_id });
