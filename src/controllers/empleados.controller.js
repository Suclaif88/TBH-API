...
exports.obtenerEmpleadoPorId = async (req, res) => {
  try {
    ...
    const empleado = await Empleados.findOne({ where: { Documento: documento } });
...
exports.actualizarEmpleado = async (req, res) => {
  try {
    ...
    await Empleados.update(req.body, { where: { Documento: documento } });
...
exports.eliminarEmpleado = async (req, res) => {
  try {
    ...
    await Empleados.destroy({ where: { Documento: documento } });
